...
export default {
  ...
  methods: {
    gutenbergStylesheets() {
      ...
      return [
        addStylesheet(
          'https://wordpress.jcloud-ver-jpc.ik-server.com/wp-includes/css/dist/block-library/style.min.css?ver=5.7.2'
        ),
        addStylesheet(
          'https://wordpress.jcloud-ver-jpc.ik-server.com/wp-includes/css/dist/block-library/theme.min.css?ver=5.7.2'
        ),
        addStylesheet('https://wordpress.jcloud-ver-jpc.ik-server.com/wp-includes/css/dashicons.min.css?ver=5.7.2'),
        addStylesheet(
          'https://wordpress.jcloud-ver-jpc.ik-server.com/wp-content/plugins/advanced-gutenberg/assets/css/blocks.css?ver=2.8.0'
        ),
        addStylesheet(
          'https://wordpress.jcloud-ver-jpc.ik-server.com/wp-content/plugins/advanced-gutenberg/assets/css/fonts/material-icons.min.css?ver=5.7.2'
        ),
        addStylesheet(
          'https://wordpress.jcloud-ver-jpc.ik-server.com/wp-content/plugins/advanced-gutenberg/assets/css/colorbox.css?ver=2.8.0'
        ),
        addStylesheet(
          'https://wordpress.jcloud-ver-jpc.ik-server.com/wp-content/plugins/advanced-gutenberg/assets/css/slick.css?ver=5.7.2'
        ),
        addStylesheet(
          'https://wordpress.jcloud-ver-jpc.ik-server.com/wp-content/plugins/advanced-gutenberg/assets/css/slick-theme.css?ver=5.7.2'
        ),
      ]
    },
  },
