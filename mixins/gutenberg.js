export default {
  mounted() {
    ...
    loadScript(
      process.env.wpBaseUrl + '/wp-includes/js/twemoji.js?ver=5.3.2',
      process.env.wpBaseUrl + '/wp-includes/js/wp-emoji.js?ver=5.3.2',
      process.env.wpBaseUrl + '/wp-includes/js/hoverintent-js.min.js?ver=2.2.1',
      process.env.wpBaseUrl + '/wp-includes/js/wp-embed.js?ver=5.3.2',
      process.env.wpBaseUrl +
        '/wp-content/plugins/advanced-gutenberg/assets/blocks/summary/summaryMinimized.js?ver=5.3.2',
      process.env.wpBaseUrl + '/wp-content/plugins/advanced-gutenberg/assets/js/jquery.colorbox.min.js?ver=2.3.5',
      process.env.wpBaseUrl + '/wp-content/plugins/advanced-gutenberg/assets/blocks/advvideo/lightbox.js?ver=2.3.5',
      process.env.wpBaseUrl + '/wp-content/plugins/advanced-gutenberg/assets/js/jquery.colorbox.min.js?ver=2.3.5',
      process.env.wpBaseUrl + '/wp-includes/js/jquery/ui/core.min.js?ver=1.11.4',
      process.env.wpBaseUrl + '/wp-includes/js/jquery/ui/widget.min.js?ver=1.11.4',
      process.env.wpBaseUrl + '/wp-includes/js/jquery/ui/accordion.min.js?ver=1.11.4',
      process.env.wpBaseUrl + '/wp-includes/js/jquery/ui/tabs.min.js?ver=1.11.4',
      process.env.wpBaseUrl + '/wp-content/plugins/advanced-gutenberg/assets/blocks/advtabs/frontend.js?ver=2.3.5',
      process.env.wpBaseUrl + '/wp-content/plugins/advanced-gutenberg/assets/js/slick.min.js?ver=5.3.2',
